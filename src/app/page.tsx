...
import { fetchAnnouncement, fetchNewsByLimit } from '@/utils/fetchUser';
    ...
    <UserLayout title={title}>
      <div className="relative w-full h-screen">
        ...
        <div className="flex flex-col items-center mt-8 md:mt-12 absolute top-0 left-0 w-full px-2">
          ...
          <p className="text-center text-sm md:text-base px-2 md:px-0 text-slate-200 mt-4 w-full md:w-3/4">
          Amik Serang, berdiri sejak 1995, 
          dengan berbekalan Ilmu Manajemen Informatika telah mencetak para pemimpin,
          pengusaha yang tersebar di penjuru dunia, <br /> Ayo Awali Langkah Menuju Era Society 5.0 🌟 Daftar sekarang di AMIK Serang TA 2024/2025 dan jadilah bagian dari IT Sesungguhnya.
           Prosesnya mudah, cepat, dan bisa jadi awal baru untuk meraih impianmu!</p>
          <Link href="https://docs.google.com/forms/d/e/1FAIpQLSdEx4PI21utm0N0X4Kt9dmSLCMG3ZXTnRX_xo87fC0w-Tixpg/viewform" 
          className="relative mt-6 bg-yellow-500 text-white px-4 md:px-6 text-sm md:text-base py-2 rounded-lg transition overflow-hidden 
          after:content-[''] after:absolute after:top-0 after:left-0 after:bg-[#002c4a] after:w-full after:h-0 after:opacity-0 
          hover:after:h-full hover:after:opacity-100 outline-none hover:shadow-md after:transition-all after:duration-300">
      ...
      <section id="jalurDaftar" className="flex justify-center items-center w-full bg-[#002c4a]">
        <div className="flex flex-col md:flex-row items-center w-full px-4 max-w-7xl py-10">
          ...
          <div className="flex flex-col items-center w-full">
            ...
            <p className="text-slate-200 text-center text-xs sm:text-sm">Langkah Awal Menuju Era Society 5.0 🌟 Daftar sekarang di AMIK Serang TA 2024/2025 dan jadilah bagian dari IT Sesungguhnya.
               Prosesnya mudah, cepat, dan bisa jadi awal baru untuk meraih impianmu! Swipe left untuk lihat alur registrasinya dan jangan lewatkan kesempatan ini.</p>
      ...
      <section id="pengumuman" className="max-w-7xl mx-auto py-8 mt-4">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 px-4 justify-center gap-5 md:flex-row mx-auto">
          {announcement
            .sort((a: any, b: any) => new Date(a.date).getTime() - new Date(b.date).getTime()) // Sort by date descending
            .map((item: any, i: number) => (
              <div
                key={i}
                className="bg-gradient-to-b from-[#002c4a] to-[#085386] w-full text-white px-8 py-6 shadow-md rounded-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
              >
                <div className="flex flex-col justify-between">
                  <div className="cursor-default">
                    <h1 className="text-white text-xl font-bold mb-2 border-b-4 pb-2">
                    ...
                    <h2 className="text-slate-200 text-lg md:text-xl mt-4 mb-2 font-semibold">
                      {item.title}
                    </h2>
                  </div>
                </div>
